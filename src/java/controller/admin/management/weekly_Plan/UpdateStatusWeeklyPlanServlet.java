 ...
 * @author ADMIN
 */
public class UpdateStatusWeeklyPlanServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int weeklyPlanId = Integer.parseInt(request.getParameter("weeklyplanid"));
            int action = Integer.parseInt(request.getParameter("action"));
            Weekly_PlanDAO wpd = new Weekly_PlanDAO();
            int rs = wpd.updateStatusWeekly_Plan(action, weeklyPlanId);
