...
public class Checkout2Servlet extends HttpServlet {
     ...
     */
    private final String CHECKOUT_PAGE_2 = "view/jsp/home/checkout2.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<Delivery> listOfDelivery = ddao.getAllDeliveryActive();
            if (listOfDelivery != null) {
                request.setAttribute("ListOfDelivery", listOfDelivery);
            }
