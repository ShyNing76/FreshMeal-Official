 ...
 * @author ADMIN
 */
public class PriceSelectionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!categoryName.isEmpty()) {
                ArrayList<Product> listOfPriceSelectionProduct = pd.getProductInCategoryWithPriceSelection(categoryName, Integer.parseInt(startPrice), Integer.parseInt(endPrice), Integer.parseInt(weeklyPlanId));
                if (listOfPriceSelectionProduct != null) {
                    request.setAttribute("ListOfPriceSelectionProduct", listOfPriceSelectionProduct);
                } else {
                ...
                if (!weeklyPlanId.isEmpty()) {
                    ArrayList<Product> listOfPriceSelectionProduct = pd.getProductWithPriceSelection(Integer.parseInt(startPrice), Integer.parseInt(endPrice), Integer.parseInt(weeklyPlanId));
                    if (listOfPriceSelectionProduct != null) {
                        request.setAttribute("ListOfPriceSelectionProduct", listOfPriceSelectionProduct);
                    } else {
                        request.setAttribute("Error", "Cann't Find Any Product");
