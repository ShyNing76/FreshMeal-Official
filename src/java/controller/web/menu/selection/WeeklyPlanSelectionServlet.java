 ...
 * @author ADMIN
 */
public class WeeklyPlanSelectionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<Product> listOf6ProductInWeeklyPlan = wppdao.getTop6ProductInWeekly_PlanByID(Integer.parseInt(weeklyPlanId));
