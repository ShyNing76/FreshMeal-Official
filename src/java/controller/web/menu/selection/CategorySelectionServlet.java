...
public class CategorySelectionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<Product> listOfFilterCategoryAndWeeklyPlanProduct = wppdao.getProductInWeekly_PlanByDateAndCategory(Integer.parseInt(weeklyPlanId), categoryName);
            ...
            if (listOfFilterCategoryAndWeeklyPlanProduct != null) {
                request.setAttribute("ListOfFilterCategoryAndWeeklyPlanProduct", listOfFilterCategoryAndWeeklyPlanProduct);
            } else {
