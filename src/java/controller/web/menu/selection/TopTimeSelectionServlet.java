 ...
 * @author ADMIN
 */
public class TopTimeSelectionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!categoryName.isEmpty()) {
                ArrayList<Product> listOfTopTimeProduct = pdao.getProductInCategoryWithTopTime(categoryName);
                if (listOfTopTimeProduct != null) {
                    request.setAttribute("ListOfTopTimeProduct", listOfTopTimeProduct);
                } else {
                ...
                if (!weeklyPlanId.isEmpty()) {
                    ArrayList<Product> listOfTopTimeProduct = pdao.getProductWithTopTime(Integer.parseInt(weeklyPlanId));
                    if (listOfTopTimeProduct != null) {
                        request.setAttribute("ListOfTopTimeProduct", listOfTopTimeProduct);
                    } else {
                        request.setAttribute("Error", "Cann't Find Any Product");
