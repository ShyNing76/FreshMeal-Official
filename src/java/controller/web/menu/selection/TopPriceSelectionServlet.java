 ...
 * @author ADMIN
 */
public class TopPriceSelectionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!categoryName.isEmpty()) {
                ArrayList<Product> listOfTopPriceProduct = pd.getProductByCategoryWithTopPrice(categoryName, Integer.parseInt(weeklyPlanId));

                if (listOfTopPriceProduct != null) {
                    request.setAttribute("ListOfTopPriceProduct", listOfTopPriceProduct);
                } else {
                ...
                if (!weeklyPlanId.isEmpty()) {
                    ArrayList<Product> listOfTopPriceProduct = pd.getProductWithTopPrice(Integer.parseInt(weeklyPlanId));
                    if (listOfTopPriceProduct != null) {
                        request.setAttribute("ListOfTopPriceProduct", listOfTopPriceProduct);
                    } else {
                        request.setAttribute("Error", "Cann't Find Any Product");
