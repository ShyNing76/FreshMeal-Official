 ...
 * @author ADMIN
 */
public class AllTimeSelectionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!categoryName.isEmpty()) {
                ArrayList<Product> listOfFilterCategoryProduct = pdao.getProductInCategoryWithAllTimeSelection(categoryName, Integer.parseInt(weeklyPlanId));
                ...
                if (!weeklyPlanId.isEmpty()) {
                    ArrayList<Product> listOfFilterCategoryProduct = pdao.getProductWithAllTimeSelection(Integer.parseInt(weeklyPlanId));
                    if (listOfFilterCategoryProduct != null) {
                        request.setAttribute("ListOfFilterCategoryProduct", listOfFilterCategoryProduct);
                    } else {
                        request.setAttribute("Error", "Cann't Find Any Product");
